...
@Mod(
        ...
        dependencies = "required-after:Forge@[10.13.2.1291,);" + "required-after:YAMCore@[0.5.65,);")
    ...
    public void postInit(FMLPostInitializationEvent event) {
        if (Config.LoadConfig()) {
            ...
            MinecraftForge.EVENT_BUS.register(tUseItemEvent);
                ...
                Reference.MODID
                        + " will NOT do anything as there where errors in the postInit event. Check the logfile!");
    }
