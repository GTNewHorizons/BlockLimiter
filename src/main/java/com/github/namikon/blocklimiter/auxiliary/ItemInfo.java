...
public class ItemInfo {
    ...
    private void InitBlockInfoInstance(String pItemConfig) {
        ...
        if (tBlockInfoArray1.length == 1) {
            BlockLimiter.Logger.info(
                    "New restrictive Item added: " + _mItemDescriptor.toString() + " Item is denied in ALL dimensions");
            _mGlobalDenied = true;
        } else {
            ...
            BlockLimiter.Logger.info(
                    "New restrictive Item added: " + _mItemDescriptor.toString()
                            + " Item is denied in "
